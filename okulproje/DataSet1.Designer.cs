...
namespace okulproje {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class TBLOGRENCIDataTable : global::System.Data.TypedTableBase<TBLOGRENCIRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public TBLOGRENCIRow AddTBLOGRENCIRow(string OGRAD, string OGRSOYAD, string OGRCINSIYET, string KULUPAD) {
        ...
        public partial class TBLOGRENCIRow : global::System.Data.DataRow {
            ...
            public string KULUPAD {
                get {
                    try {
                        return ((string)(this[this.tableTBLOGRENCI.KULUPADColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("\'TBLOGRENCI\' tablosundaki \'KULUPAD\' sütunun değeri DBNull.", e);
                    }
                }
                set {
                    this[this.tableTBLOGRENCI.KULUPADColumn] = value;
                }
            }
            ...
            public bool IsKULUPADNull() {
                return this.IsNull(this.tableTBLOGRENCI.KULUPADColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetKULUPADNull() {
                this[this.tableTBLOGRENCI.KULUPADColumn] = global::System.Convert.DBNull;
            }
        }
    ...
    public partial class TBLOGRENCITableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        TBLOGRENCI.OGRID, TBLOGRENCI.OGRAD, TBLOGRENCI.OGRSOYAD, TBLOGRENCI" +
                ".OGRCINSIYET, TBLKULUP.KULUPAD\r\nFROM            TBLOGRENCI INNER JOIN\r\n         " +
                "                TBLKULUP ON TBLOGRENCI.OGRKULUP = TBLKULUP.KULUPID";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = @"SELECT        TBLOGRENCI.OGRID, TBLOGRENCI.OGRAD, TBLOGRENCI.OGRSOYAD, TBLOGRENCI.OGRCINSIYET, TBLKULUP.KULUPAD
FROM            TBLOGRENCI INNER JOIN
                         TBLKULUP ON TBLOGRENCI.OGRKULUP = TBLKULUP.KULUPID
WHERE        (TBLOGRENCI.OGRAD = @OGRAD)";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual DataSet1.TBLOGRENCIDataTable öğrencilistesi() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
        ...
        public virtual int FillBy(DataSet1.TBLOGRENCIDataTable dataTable, string OGRAD) {
        ...
        public virtual DataSet1.TBLOGRENCIDataTable ÖĞRENCİGETİR(string OGRAD) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((OGRAD == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, false)]
        public virtual int ÖĞRENCİGÜNCELLE(string OGRAD, string OGRSOYAD, global::System.Nullable<byte> OGRKULUP, string OGRCINSIYET, int OGRID) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[3];
            if ((OGRAD == null)) {
                command.Parameters[0].Value = global::System.DBNull.Value;
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, false)]
        public virtual int ÖĞRENCİSİL(int OGRID) {
